...
4. **ASK USER** - Use `→ **CHAT GATE** — Present the question in chat and wait for user response` with options:
...
| `accounting-archetype-mapper` | Maps domains to the accounting archetype (value tracking, ledger, double-entry). Fit-test hard stop when pricing archetype is a better match. | `skills/accounting-archetype-mapper/SKILL.md` |
| `pricing-archetype-mapper` | Maps domains to the pricing archetype (computed prices, component trees, validity). Fit-test hard stop when accounting archetype is a better match. | `skills/pricing-archetype-mapper/SKILL.md` |
...
| `/maister-modeling-accounting-archetype` | `[domain description]` | Map domain to accounting archetype (ledger, value tracking) |
| `/maister-modeling-pricing-archetype` | `[domain description]` | Map domain to pricing archetype (computed prices) |
