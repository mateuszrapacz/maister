---
description: "Generates ASCII mockups showing UI layout and integration with existing components. Analyzes codebase to identify current layout patterns, reusable components, and navigation structure. Creates annota"
mode: subagent
permission:
  edit: allow
  bash: ask
