---
description: "Automated code quality, security, and performance analysis. Analyzes code for complexity, duplication, security vulnerabilities, performance issues, and best practices compliance. Can run standalone ("
mode: subagent
permission:
  edit: allow
  bash: ask
