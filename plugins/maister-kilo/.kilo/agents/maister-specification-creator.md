---
description: "Creates comprehensive specifications from gathered requirements. Searches for reusable code, writes spec.md with reusability analysis, and self-verifies quality. Receives pre-gathered requirements - d"
mode: subagent
permission:
  edit: allow
  bash: ask
