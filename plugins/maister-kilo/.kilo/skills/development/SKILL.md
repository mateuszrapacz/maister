...
`skills/orchestrator-framework/references/gate-decision-engine.md`. The call
...
The `→ **CHAT GATE** — Present the question in chat and wait for user response` lines below describe the host adapter's
...
`skills/orchestrator-framework/references/gate-decision-engine.md` first. Build
...
to `skills/orchestrator-framework/bin/phase-continue.mjs` with the exact state
...
Host adapter presentation matrix (each `→ **CHAT GATE** — Present the question in chat and wait for user response` entry is a presentation
primitive behind the engine; it never bypasses `evaluate_gate`):

- `phase-1-clarification`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-1-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-2-scope-decision`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-2-routing`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-3-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-4-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `requirements-clarification`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-5-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `optional-phase-selection/spec-audit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-6-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-7-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `implementation-approval`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-8-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-9-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `verification-options`: → **CHAT GATE** — Present the question in chat and wait for user response
- `optional-phase-selection/e2e`: → **CHAT GATE** — Present the question in chat and wait for user response
- `optional-phase-selection/user-docs`: → **CHAT GATE** — Present the question in chat and wait for user response
- `verification-fix-selection`: → **CHAT GATE** — Present the question in chat and wait for user response
- `verification-rerun`: → **CHAT GATE** — Present the question in chat and wait for user response
- `verification-known-issues`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-11-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-12-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `phase-13-exit`: → **CHAT GATE** — Present the question in chat and wait for user response
- `final-handoff-approval`: → **CHAT GATE** — Present the question in chat and wait for user response
...
3. For each critical clarification, invoke the engine as `phase-1-clarification` with the exact question and the ordered options from the checklist; `→ **CHAT GATE** — Present the question in chat and wait for user response` is only its user-gate adapter.
...
→ **MANDATORY GATE** — invoke the shared engine for `phase-2-routing` now; its user adapter is `→ **CHAT GATE** — Present the question in chat and wait for user response`, and continuation requires the persisted terminal decision.
...
→ **MANDATORY GATE** — invoke the shared gate engine now; `→ **CHAT GATE** — Present the question in chat and wait for user response` is only its user-gate adapter. Proceeding without a persisted terminal engine record is a protocol violation.
...
**Execute**: Direct - build the complete `verification-options` gate context and invoke the shared engine; `→ **CHAT GATE** — Present the question in chat and wait for user response` is only the adapter.
