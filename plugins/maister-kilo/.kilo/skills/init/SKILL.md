...
**If exists**, use → **CHAT GATE** — Present the question in chat and wait for user response:
...
**Step 2**: Use → **CHAT GATE** — Present the question in chat and wait for user response to confirm analysis accuracy. If corrections needed, collect them.

**Step 3**: Gather additional context. Present your best guesses (inferred from codebase analysis) and ask the user to confirm or correct in a **single** → **CHAT GATE** — Present the question in chat and wait for user response:
...
**Step 4**: Ask which project documentation to generate using → **CHAT GATE** — Present the question in chat and wait for user response (multi-select):
...
Show smart defaults summary (noting the source: external project or built-in), then use → **CHAT GATE** — Present the question in chat and wait for user response:
