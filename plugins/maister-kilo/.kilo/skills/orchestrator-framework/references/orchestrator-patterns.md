...
2. **Present**: Use `→ **CHAT GATE** — Present the question in chat and wait for user response` for each critical decision; batch important decisions into multi-select
