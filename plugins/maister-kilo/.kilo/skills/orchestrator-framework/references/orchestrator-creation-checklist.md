...
- [ ] **Decision gates** — Phases receiving `decisions_needed` present to user via → **CHAT GATE** — Present the question in chat and wait for user response
- [ ] **Interactive mode** — `→ **CHAT GATE** — Present the question in chat and wait for user response` at every `→ Pause` transition
...
| Implicit user prompts without → **CHAT GATE** — Present the question in chat and wait for user response | User loses control |
...
| Auto-accepting subagent decisions | User must consent via → **CHAT GATE** — Present the question in chat and wait for user response |
