...
`skills/orchestrator-framework/bin/phase-continue.mjs`. A host invokes it with
...
text typed into `→ **CHAT GATE** — Present the question in chat and wait for user response`, CHAT GATE, `→ **CHAT GATE** — Present the question in chat and wait for user response`, or a plain-text user
...
| User gate | `→ **CHAT GATE** — Present the question in chat and wait for user response` | chat gate | chat gate | `→ **CHAT GATE** — Present the question in chat and wait for user response` | plain-text user question |
