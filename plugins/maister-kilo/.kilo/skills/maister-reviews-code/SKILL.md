...
1. **Path to analyze**:
   ...
   - If not provided: Use → **CHAT GATE** — Present the question in chat and wait for user response to ask what to analyze
...
Use Task tool:
  ...
  prompt: |
    Analyze code at: [path from user or from → **CHAT GATE** — Present the question in chat and wait for user response]
