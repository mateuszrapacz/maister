...
Based on the hypothesis, ask the most discriminating questions. Use `→ **CHAT GATE** — Present the question in chat and wait for user response`. Maximum 4 questions per call; use a second call if more are needed.
