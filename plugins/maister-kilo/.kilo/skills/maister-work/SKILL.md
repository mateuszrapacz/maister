...
4. Present status to user with → **CHAT GATE** — Present the question in chat and wait for user response:
...
Use → **CHAT GATE** — Present the question in chat and wait for user response with options:
