...
1. **Get the task** — Use the argument if provided. If none, ask with `→ **CHAT GATE** — Present the question in chat and wait for user response`: "What would you like to plan?"
