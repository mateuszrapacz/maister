...
- Only if no argument AND no bug context in session, use → **CHAT GATE** — Present the question in chat and wait for user response:
  ```
...
Use → **CHAT GATE** — Present the question in chat and wait for user response:
...
- Use → **CHAT GATE** — Present the question in chat and wait for user response: "The reproduction test passes — the expected behavior already works under these conditions. Is the bug description accurate, or are there additional conditions?"
