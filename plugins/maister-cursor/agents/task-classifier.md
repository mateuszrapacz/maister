...
Use AskQuestion with options: "Yes, proceed" | "No, let me choose different type"
...
Use AskQuestion with all 5 options
...
Use AskQuestion with relevant options
...
**AskQuestion**: Confirm classifications, resolve ambiguities, handle overrides
