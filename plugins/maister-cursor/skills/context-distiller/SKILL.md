...
After presenting the linguistic analysis, ask about unresolved ambiguities and uncertain generalizations. Use `AskQuestion` (up to 4 questions per call).
...
2. If affects boundary placement or generalization scope: **stop and ask** using `AskQuestion`.
