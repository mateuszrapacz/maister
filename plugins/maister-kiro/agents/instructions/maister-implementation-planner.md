...
2. Set dependencies with `todo ordering in todo list` mirroring the plan's dependency chain:
...
- One `todo` per task group
- Dependencies set via `todo ordering in todo list`
