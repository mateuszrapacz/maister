...
→ **CHAT GATE** — Present the question in chat with options: "Yes, proceed" | "No, let me choose different type"
...
→ **CHAT GATE** — Present the question in chat with all 5 options
...
→ **CHAT GATE** — Present the question in chat to let user choose
...
→ **CHAT GATE** — Present the question in chat with relevant options
...
****CHAT GATE****: Confirm classifications, resolve ambiguities, handle overrides
