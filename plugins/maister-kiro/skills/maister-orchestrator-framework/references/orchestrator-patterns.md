...
8. **Create TUI tasks**: `todo` for all phases, then `todo ordering in todo list` for dependencies. On resume, also restore completed phase statuses.
