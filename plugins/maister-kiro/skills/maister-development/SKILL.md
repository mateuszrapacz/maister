...
The **CHAT GATE** lines below describe the host adapter's
...
Host adapter presentation matrix (each **CHAT GATE** entry is a presentation
primitive behind the engine; it never bypasses `evaluate_gate`):

- `phase-1-clarification`: **CHAT GATE**
- `phase-1-exit`: **CHAT GATE**
- `phase-2-scope-decision`: **CHAT GATE**
- `phase-2-routing`: **CHAT GATE**
- `phase-3-exit`: **CHAT GATE**
- `phase-4-exit`: **CHAT GATE**
- `requirements-clarification`: **CHAT GATE**
- `phase-5-exit`: **CHAT GATE**
- `optional-phase-selection/spec-audit`: **CHAT GATE**
- `phase-6-exit`: **CHAT GATE**
- `phase-7-exit`: **CHAT GATE**
- `implementation-approval`: **CHAT GATE**
- `phase-8-exit`: **CHAT GATE**
- `phase-9-exit`: **CHAT GATE**
- `verification-options`: **CHAT GATE**
- `optional-phase-selection/e2e`: **CHAT GATE**
- `optional-phase-selection/user-docs`: **CHAT GATE**
- `verification-fix-selection`: **CHAT GATE**
- `verification-rerun`: **CHAT GATE**
- `verification-known-issues`: **CHAT GATE**
- `phase-11-exit`: **CHAT GATE**
- `phase-12-exit`: **CHAT GATE**
- `phase-13-exit`: **CHAT GATE**
- `final-handoff-approval`: **CHAT GATE**
...
3. For each critical clarification, invoke the engine as `phase-1-clarification` with the exact question and the ordered options from the checklist; **CHAT GATE** is only its user-gate adapter.
...
→ **CHAT GATE** — invoke the shared engine for `phase-2-routing` now; its user adapter is **CHAT GATE**, and continuation requires the persisted terminal decision.
...
→ **CHAT GATE** — invoke the shared gate engine now; **CHAT GATE** is only its user-gate adapter. Proceeding without a persisted terminal engine record is a protocol violation.
...
**Execute**: Direct - build the complete `verification-options` gate context and invoke the shared engine; **CHAT GATE** is only the adapter.
...
**Q1** (always): invoke `verification-options` (sequential single-choice) — "Which standard verifications to run?"
...
→ **CHAT GATE** — persist the terminal `verification-options` and optional-phase records through the shared engine before continuing.
