...
3. Launch both subagents in the same message with `run_in_background: true`:
 - subagent tool with agent: `maister-thermo-nuclear-review-subagent` for bugs, breakages, security, devex regressions, feature-flag leaks, and other branch-audit risks.
 - subagent tool with agent: `maister-thermo-nuclear-code-quality-review-subagent` for maintainability, structure, file-size growth, spaghetti, abstractions, and codebase-health risks.
