...
After presenting the linguistic analysis, ask about unresolved ambiguities and uncertain generalizations. → **CHAT GATE** — Present the question in chat (up to 4 questions per call).
...
2. If affects boundary placement or generalization scope: **stop and ask** using **CHAT GATE**.
