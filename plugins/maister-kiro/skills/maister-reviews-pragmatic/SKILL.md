...
1. **Path to analyze**:
   ...
   - If not provided: → **CHAT GATE** — Present the question in chat to ask what to analyze (file, directory, or task path)

## Your Instructions

**Invoke the code-quality-pragmatist agent NOW using the subagent tool:**
