...
1. **Path to analyze**:
   ...
   - If not provided: → **CHAT GATE** — Present the question in chat to ask what to check
...
**Invoke the production-readiness-checker subagent NOW using the subagent tool:**
