...
Based on the hypothesis, ask the most discriminating questions. → **CHAT GATE** — Present the question in chat. Maximum 4 questions per call; use a second call if more are needed.
