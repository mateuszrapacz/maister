...
- If neither, AskQuestion: "Describe the bug — expected vs actual behavior?"
...
AskQuestion: **Approve** / **Revise** / **Cancel**. Do not proceed to TDD without approval.

### Step 6: TDD Red Gate

Write a failing test reproducing the bug. Run it — must fail. If it passes, AskQuestion whether description is accurate.
