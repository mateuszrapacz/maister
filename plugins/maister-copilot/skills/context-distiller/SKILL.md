...
After presenting the linguistic analysis, ask about unresolved ambiguities and uncertain generalizations. Use `ask_user` (up to 4 questions per call).
...
2. If affects boundary placement or generalization scope: **stop and ask** using `ask_user`.
