...
The `plain-text user question` lines below describe the host adapter's
...
Host adapter presentation matrix (each `plain-text user question` entry is a presentation
primitive behind the engine; it never bypasses `evaluate_gate`):

- `phase-1-clarification`: plain-text user question
- `phase-1-exit`: plain-text user question
- `phase-2-scope-decision`: plain-text user question
- `phase-2-routing`: plain-text user question
- `phase-3-exit`: plain-text user question
- `phase-4-exit`: plain-text user question
- `requirements-clarification`: plain-text user question
- `phase-5-exit`: plain-text user question
- `optional-phase-selection/spec-audit`: plain-text user question
- `phase-6-exit`: plain-text user question
- `phase-7-exit`: plain-text user question
- `implementation-approval`: plain-text user question
- `phase-8-exit`: plain-text user question
- `phase-9-exit`: plain-text user question
- `verification-options`: plain-text user question
- `optional-phase-selection/e2e`: plain-text user question
- `optional-phase-selection/user-docs`: plain-text user question
- `verification-fix-selection`: plain-text user question
- `verification-rerun`: plain-text user question
- `verification-known-issues`: plain-text user question
- `phase-11-exit`: plain-text user question
- `phase-12-exit`: plain-text user question
- `phase-13-exit`: plain-text user question
- `final-handoff-approval`: plain-text user question
...
3. For each critical clarification, invoke the engine as `phase-1-clarification` with the exact question and the ordered options from the checklist; `plain-text user question` is only its user-gate adapter.
...
→ **MANDATORY GATE** — invoke the shared engine for `phase-2-routing` now; its user adapter is `plain-text user question`, and continuation requires the persisted terminal decision.
...
**Execute**: Direct - build the complete `verification-options` gate context and invoke the shared engine; `plain-text user question` is only the adapter.
