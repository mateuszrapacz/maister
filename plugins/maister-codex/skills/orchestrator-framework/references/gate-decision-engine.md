...
text typed into `plain-text user question`, CHAT GATE, `ask_user`, or a plain-text user
...
| User gate | `plain-text user question` | chat gate | chat gate | `ask_user` | plain-text user question |
