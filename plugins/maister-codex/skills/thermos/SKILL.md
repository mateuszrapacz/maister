...
3. Launch both subagents in the same message with `run_in_background: true`:
 - agent role: "native Codex subagent" for bugs, breakages, security, devex regressions, feature-flag leaks, and other branch-audit risks.
 - agent role: "native Codex subagent" for maintainability, structure, file-size growth, spaghetti, abstractions, and codebase-health risks.
