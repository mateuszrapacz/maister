...
Based on the hypothesis, ask the most discriminating questions. Use `plain-text user question`. Maximum 4 questions per call; use a second call if more are needed.
