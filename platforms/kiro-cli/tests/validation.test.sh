...
# 6. Rules 14/28: exactly 71 total / 46 maister-* skill directories
test_exactly_71_skill_dirs() {
  run_build
  ...
  test "$total" -eq 71 && test "$prefixed" -eq 46
}
...
assert "exactly 71 total / 46 maister-* skill directories (rules 14/28)" test_exactly_71_skill_dirs
