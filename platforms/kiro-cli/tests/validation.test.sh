...
# 6. Rules 14/28: exactly 22 maister-* skill directories
test_exactly_22_skill_dirs() {
  run_build
  ...
  test "$total" -eq 22 && test "$prefixed" -eq 22
}
...
assert "exactly 22 maister-* skill directories (rules 14/28)" test_exactly_22_skill_dirs
