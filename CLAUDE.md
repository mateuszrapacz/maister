...
**NEVER directly modify files under `plugins/maister-copilot/`, `plugins/maister-cursor/`, or `plugins/maister-kiro/`** — those are auto-generated by the `make` command. Always edit the source files in `plugins/maister/` (and platform transforms in `platforms/*/`) instead. Changes to generated variants will be overwritten.
...
├── maister-copilot/               # Generated — Copilot CLI
