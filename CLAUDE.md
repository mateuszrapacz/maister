...
**NEVER directly modify files under `plugins/maister-cursor/`, `plugins/maister-kiro/`, or `plugins/maister-codex/`** — those are auto-generated by the `make` command. Always edit the source files in `plugins/maister/` and platform transforms in `platforms/*/` instead. Changes to generated variants will be overwritten.
...
plugins/
├── maister/                       # Main plugin (source of truth)
├── maister-cursor/                # Generated — Cursor Agent
├── maister-kiro/                  # Generated — Kiro CLI
└── maister-codex/                 # Generated — Codex CLI / IDE
platforms/
├── cursor/build.sh
├── kiro-cli/build.sh
└── codex-cli/build.sh
...
These files need version/name changes during the merge workflow:
